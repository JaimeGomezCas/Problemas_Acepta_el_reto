...
public class P003 {
    ...
    public static String casoDePrueba(){
        String mensajeCodificado = sc.nextLine().toUpperCase();
        char primeraLetra = mensajeCodificado.charAt(0);
        int clave = primeraLetra - 'P';
        String mensajeDecodificado = decodificarMensaje(clave, mensajeCodificado);
        System.out.println(contadorVocales(mensajeCodificado));
